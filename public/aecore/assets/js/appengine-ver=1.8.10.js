...
(function(AE, $, Backbone, Views, Models, Collections) {
    ...
    AE.Views.BlockUi = Backbone.View.extend({
        ...
        initialize: function(options) {
            ...
            this.overlay = $('<div class="loading-blur loading"><div class="loading-overlay"></div><div class="gre-loading-wrap"><div class="gre-loading"></div></div></div>');
    ...
    */
    ...
    Views.SubmitPost = Backbone.Marionette.View.extend({
        events: {
            ...
            // previous
            'click .gre-btn-previous': 'showPreviousStep',
            ...
            $("form.post").validate({
                ...
                highlight: function(element, errorClass, validClass) {
                    if($(element).attr('type') == 'checkbox'){
                        ...
                        var $container = $(element).closest('div.gre-input-field');
        ...
        choosePlan : function($target) {
            ...
            var $checked = $('.gre-post-package li input:checked').closest('li');
        ...
        extendPayment: function(event) {
            ...
            if( typeof packageType == 'undefined'){
                packageType = $(".gre-post-package li").attr("data-package-type");
                // custom to checkout without the first step - step select package.
                // remember use only 1 element <li> on the ul.gre-post-package
            }
        ...
        showPreviousStep: function(e){
            ...
            var view = this;
            var target = e.currentTarget;
            view.$(target).closest('.gre-post-project-step').removeClass('active');
            view.$(target).closest('.gre-post-project-step').prev().addClass('active');
