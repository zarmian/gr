    ...
    $(document).ready(function() {
        ...
        Views.PrivateMessagePage = Backbone.View.extend({
            ...
            initialize: function(){
                ...
                /*$('.gre-inbox-message').mCustomScrollbar({
                    setHeight:540,
                    setTop:"-1000000px",
                    callbacks:{
                        onInit:function(){},
                ...
                $('.gre-back-inbox-btn').on('click', function() {
            ...
            initConversationDetail: function(data){
                ...
                prMsgReplyItem = Views.PostItem.extend({
                    ...
                    onItemRendered: function() {
                        ...
                        var view = this;
                        view.$el.prependTo('.gre-conversation-list');
                ...
                if( $('.private-message-reply-contents').length > 0 ) {
                    ...
                    view.reblockcontrol = new Views.BlockControl({
                        ...
                        onAfterFetch: function(result, res){
                            ...
                            $('.gre-inbox-message').mCustomScrollbar('destroy');
                        ...
                        loadMore: function(){
                            ...
                            this.collection.fetch({
                                ...
                                beforeSend: function() {
                                    ...
                                    if(view.stopScroll) {
                                        $('.gre-inbox-message').prepend(infinite_scroll);
                                    }
                                },
                                success: function(result, res, xhr) {
                                    ...
                                    $('.first_in_day').click();
                                    $('.gre-inbox-message').find('.infinite_scroll').remove();
                                }
                            });
        ...
        if(window.innerWidth >= 767) {
            $('select.gre-filter-conversation').css('display','block').css('position','absolute');
        }
