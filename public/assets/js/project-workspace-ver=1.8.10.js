    ...
    $(document).ready(function () {
        ...
        Views.WorkPlaces = Backbone.View.extend({
            events: {
                ...
                'submit form.gre-workspace-form': 'submitAttach'
            },
            initialize: function (options) {
                var view = this;
                view.blockUi = new Views.BlockUi();
...
(function ($, Models, Collections, Views) {
    $(document).ready(function () {
        ...
        ReportItem = Views.PostItem.extend({
            ...
            onItemRendered: function () {
                var view = this;
                view.$el.prependTo('.gre-conversation-disputed-list');
        ...
        Views.ReportPlaces = Backbone.View.extend({
            ...
            initialize: function (options) {
                ...
                this.ListMsg = new ListReport({
                    ...
                    el: $('.report-container').find('.gre-conversation-disputed-list')
                });
                /**
                 * init block control list blog
                 */
                ...
                $('.gre-conversation-disputed-wrap').mCustomScrollbar({
                    setHeight: 524,
                    setTop: "-1000000px",
                    callbacks: {
                        onInit: function () {
