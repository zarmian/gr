(function ($, Views, Models, Collections) {
    ...
    new ListFreelancerCurrentProject({
        ...
        el: FreelancerCurrentProjectTab.find('.gre-current-table-rows')
    });
    new Views.BlockControl({
        ...
        onAfterFetch: function (result, res) {
            if (!res.success || result.length == 0) {
                $freelancer_current.find('.gre-table').after(ae_globals.text_message.no_project);
            }
        },
    ...
    new ListFreelancerPreviousProject({
        ...
        el: FreelancerPreviousProjectTab.find('.gre-previous-table-rows')
    });
    new Views.BlockControl({
        ...
        onAfterFetch: function (result, res) {
            if (!res.success || result.length == 0) {
                $freelancer_previous.find('.gre-table').after(ae_globals.text_message.no_project);
            }
        },
        onAfterInit: function () {
            var view = this;
    ...
    new ListEmployerCurrentProject({
        ...
        el: EmployerCurrentProjectTab.find('.gre-current-table-rows')
    });
    new Views.BlockControl({
        el: $employer_current,
        collection: EmployerCurrentProjectCollection,
        ...
        onAfterFetch: function (result, res) {
            if (!res.success || result.length == 0) {
                $employer_current.find('.gre-table').after(ae_globals.text_message.no_project);
            }
        },
        onAfterInit: function () {
            var view = this;
    ...
    new ListEmployerPreviousProject({
        ...
        el: EmployerPreviousProjectTab.find('.gre-previous-table-rows')
    });
    new Views.BlockControl({
        ...
        onAfterFetch: function (result, res) {
            if (!res.success || result.length == 0) {
                $employer_previous.find('.gre-table').after(ae_globals.text_message.no_project);
            }
        },
        onAfterInit: function () {
            var view = this;
